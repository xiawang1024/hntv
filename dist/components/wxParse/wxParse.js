...
function wxParse() {
	...
	var data =
		arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '<div class="color:red;">数据不能为空</div>';
...
function calMoreImageInfo(e, idx, that, bindName) {
	...
	try {
		for (
			var _iterator = index.split('.')[Symbol.iterator](), _step;
	...
	that.setData(
		((_that$setData = {}),
		_defineProperty(_that$setData, keyW, recal.imageWidth),
		_defineProperty(_that$setData, keyH, recal.imageheight),
		_that$setData)
	);
}
